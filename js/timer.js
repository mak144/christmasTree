...
const timer = () => {
   ...
   const startTimer = () => {
      ...
      const s = decloofNum(seconds, ['cекунда', 'секунды', 'секунд']);
      const m = decloofNum(minutes, ['минута', 'минуты', 'минут']);
      const h = decloofNum(hours, ['час', 'часа', 'часов']);
      const d = decloofNum(days, ['день', 'дня', 'дней']);
